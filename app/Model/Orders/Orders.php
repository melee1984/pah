...
class Orders extends Model
{
	...
	protected $fillable = array('user_id', 'cart_id', 'submitted_at', 'partner_id', 'rider_id', 'store_accepted_at', 'accepted_by_rider_at', 'accepted_at', 'delivered_at', 'updated_at', 'created_at', 'status_id', 'order_status_id', 'booking_status_id');
