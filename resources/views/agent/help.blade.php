...
@section('content')
    ...
    <nav class="agent-help-jump" aria-label="Help topics">
        <a href="#getting-started">Getting started</a><a href="#documents">Documents &amp; review</a><a href="#earnings">Earnings</a><a href="#account">Account &amp; payouts</a>
    </nav>
    ...
    <div class="agent-help-layout">
        <main class="agent-help-main">
            ...
            <section class="agent-help-section" id="earnings"><div class="agent-help-section-head"><span>03</span><div><h2>Earnings</h2><p>How qualifying order commission is recorded.</p></div></div>
                <div class="agent-help-questions">
            ...
            <section class="agent-help-section" id="account"><div class="agent-help-section-head"><span>04</span><div><h2>Account &amp; payouts</h2><p>Access and payment questions.</p></div></div>
                <div class="agent-help-questions">
