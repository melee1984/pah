...
@section('content')
    ...
    <section class="agent-guide" aria-labelledby="agent-guide-title">
        ...
        <div class="agent-guide-steps">
            <article><span>01</span><h3>Register the restaurant</h3><p>Open <a href="{{ route('agent.restaurants.create') }}">Enroll</a> and enter the restaurant, contact, business registration, address, and payout account details. The restaurant contact receives an invitation to set up their account.</p></article>
            <article><span>02</span><h3>Provide the documents</h3><p>Upload the available ID, business registration, current business and sanitary permits, BIR certificate, and payout proof. An authorization document is also required when the enrollee is not the owner. Missing files can be added later.</p></article>
