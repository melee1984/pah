@if (!Request::is('restaurant/*') && !Request::is('restaurants'))
	...
	<div class="fb-customerchat" attribution=setup_tool page_id="106782101100929" theme_color="#fa3c4c"
		logged_in_greeting="Hey whats up? can we help you? " logged_out_greeting="Hey whats up? can we help you? ">
	</div>
@endif
        ...
        <div class="footer-top">
            ...
            <div class="footer-area text-center">
                ...
                <div class="scocial-media">
                    <a href="https://www.facebook.com/pahatudDelivery" class="facebook"><i
