  ...
  methods: {
    ...
    onFileSelected(event) {
      ...
      if (!['image/jpeg', 'image/png'].includes(file.type) || file.size > 2 * 1024 * 1024) {
        this.fileImage = null;
        this.imageUploadError = 'Choose a JPG or PNG image up to 2 MB.';
        event.target.value = '';
        return;
      }
      this.fileImage = file;
