<template>
    <div class="container">
            ...
            <div class="section-wrapper d-none d-sm-block d-sm-none d-md-block" v-if="!loading">
                <div class="row ">
                    <!-- Restaurant Display -->
                    <div class="col-xl-3 col-md-3 col-sm-4 col-12" v-for="restaurant in data">
                        <div class="p-food-item">
                            <div class="p-food-inner">
                                <div class="p-food-thumb">
                                    <a :href="'/flowerstore/'+restaurant.slug">
                                        <img :src="''+restaurant.img"  alt="p-food">
                                    </a>
                                  <!--   <span>$20 - $30</span> -->
                                </div>
                                <div class="p-food-content pt-0 mt-0">
                                    <h6><a :href="'/flowerstore/'+restaurant.slug">{{ restaurant.restaurant_name }}</a></h6>
                                    <div class="p-food-group" v-if="restaurant.food_type.length">
                                        <a :href="'/flowerstore/'+restaurant.slug" v-for="foodType in restaurant.food_type">{{ foodType.title }}</a>
                                    </div>
            ...
            <div class="d-block d-sm-none d-none d-sm-block d-md-none" v-if="!loading">
                <div class="row" v-for="restaurant in data" style="margin-bottom: 20px;">
                    ...
                    <div class="col-8 p-l-10 p-b-2">
                        <a :href="'/flowerstore/'+restaurant.slug" style="font-size: 18px;">
                            <strong>{{ restaurant.restaurant_name }}</strong></a>
...
<script>
    ...
    export default {
        ...
        methods: {
            fetchData: function() {
                if (page_url!='flowerstore') return;
                
                    var self = this;
                    self.loading = true;
                    axios.get('/api/flowerstore').then(function (response) {
