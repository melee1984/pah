<template>
  <div class="product style-2 padding-tb">
    <div class="container">
      ...
      <div class="scroll">
        <nav class="text-center">
          <a
            ...
            class="p-3 categorymenu"
            v-for="category in restaurant.category"
            :id="'cat_' + category.identifier"
            v-on:click="openMenu(category.identifier)"
      ...
      <div class="container p-0">
        <div class="section-wrapper">
          <div class="row justify-content-center">
            ...
            <div
              class="col-xl-12 col-sm-12 col-xs-12"
              v-for="category in restaurant.category"
              v-if="category.products.length > 0"
            >
              <article>
                    ...
                    <div class="product-list-item">
                      <div class="product-thumb" v-if="product.img">
                        ...
                        <div class="product-action-link">
                          <a
                            href="javascript:void(0)"
                            v-on:click="selectedVariance(product)"
    ...
    <variance-modal-components
      v-bind:display="display"
      v-bind:productInfo="selectedProduct"
      ref="variantModal"
      v-bind:addingthisformerchant="addingThisForMerchant"
    ></variance-modal-components>
  </div>
</template>
  ...
  methods: {
    selectedVariance: function (product) {
      if (product.variants.length > 0) {
        ...
        this.$refs.variantModal.openModal();
    ...
    addCart: function (product) {
      if (!this.addingThisForMerchant) {
        Swal.fire({
          title: "Are you sure?",
          text: "You are adding an item with different Merchant/Restaurant. Your current cart will be set to empty. Do you want us to proceed?",
          icon: "warning",
          showCancelButton: true,
          confirmButtonColor: "#3085d6",
          cancelButtonColor: "#d33",
          confirmButtonText: "Yees"
        }).then((result) => {
